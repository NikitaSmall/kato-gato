    ...
    for(var i = 0; i < length; i++) {
        if( // search for links at word
          ...
          if( // search for pictures at link
            ...
            wordsArray[i].indexOf('youtube') > -1 || wordsArray[i].indexOf('https://') > -1
          ) {
            wordsArray[i] = '<iframe src="http://www.youtube.com/embed/' + wordsArray[i].replace(RegExp('[.|,|:|;|?|!|)|()]*$'), '').match(/v=(.*)/)[1] + '"></iframe>';
